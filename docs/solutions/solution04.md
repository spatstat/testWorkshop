...
1.  Repeat the command `plot(rpoispp(100))` several times to build your intuition about the appearance of a completely random pattern of points.
    ...
    ![](/home/rubak/spatstat/testWorkshop/docs/solutions/solution04_files/figure-markdown_github/unnamed-chunk-3-1.png)![](/home/rubak/spatstat/testWorkshop/docs/solutions/solution04_files/figure-markdown_github/unnamed-chunk-3-2.png)![](/home/rubak/spatstat/testWorkshop/docs/solutions/solution04_files/figure-markdown_github/unnamed-chunk-3-3.png)
...
2.  Try the same thing with intensity \(\lambda = 1.5\).
    ...
    ![](/home/rubak/spatstat/testWorkshop/docs/solutions/solution04_files/figure-markdown_github/unnamed-chunk-4-1.png)
...
1.  Plot a kernel smoothed intensity estimate.
    ...
    ![](/home/rubak/spatstat/testWorkshop/docs/solutions/solution04_files/figure-markdown_github/unnamed-chunk-8-1.png)
...
4.  Plot the fitted model intensity (using `plot(predict(fit))`)
    ...
    ![](/home/rubak/spatstat/testWorkshop/docs/solutions/solution04_files/figure-markdown_github/unnamed-chunk-11-1.png)

    ``` {.r}
    plot(predict(jp.m, se=TRUE)$se, main = "")
    ```

    ![](/home/rubak/spatstat/testWorkshop/docs/solutions/solution04_files/figure-markdown_github/unnamed-chunk-11-2.png)

    ``` {.r}
    plot(predict(jp.m2), main = "")
    ```

    ![](/home/rubak/spatstat/testWorkshop/docs/solutions/solution04_files/figure-markdown_github/unnamed-chunk-11-3.png)

    ``` {.r}
    plot(predict(jp.m2, se=TRUE)$se, main = "")
    ```

    ![](/home/rubak/spatstat/testWorkshop/docs/solutions/solution04_files/figure-markdown_github/unnamed-chunk-11-4.png)
...
6.  Generate 10 simulated realisations of the fitted log-quadratic model, and plot them, using `plot(simulate(fit, nsim=10))` where `fit` is the fitted model.
    ...
    ![](/home/rubak/spatstat/testWorkshop/docs/solutions/solution04_files/figure-markdown_github/unnamed-chunk-13-1.png)
...
3.  Plot the fitted intensity as a colour image.
    ...
    ![](/home/rubak/spatstat/testWorkshop/docs/solutions/solution04_files/figure-markdown_github/unnamed-chunk-19-1.png)
...
5.  Compute and plot the standard error of the intensity estimate (see `help(predict.ppm)`).
    ...
    ![](/home/rubak/spatstat/testWorkshop/docs/solutions/solution04_files/figure-markdown_github/unnamed-chunk-21-1.png)
...
![](/home/rubak/spatstat/testWorkshop/docs/solutions/solution04_files/figure-markdown_github/unnamed-chunk-23-1.png)

``` {.r}
plot(predict(ppm2), main = "")
```

![](/home/rubak/spatstat/testWorkshop/docs/solutions/solution04_files/figure-markdown_github/unnamed-chunk-23-2.png)

``` {.r}
plot(predict(ppm3), main = "")
```

![](/home/rubak/spatstat/testWorkshop/docs/solutions/solution04_files/figure-markdown_github/unnamed-chunk-23-3.png)

``` {.r}
plot(predict(ppm4), main = "")
```

![](/home/rubak/spatstat/testWorkshop/docs/solutions/solution04_files/figure-markdown_github/unnamed-chunk-23-4.png)

``` {.r}
plot(predict(ppm5), main = "")
```

![](/home/rubak/spatstat/testWorkshop/docs/solutions/solution04_files/figure-markdown_github/unnamed-chunk-23-5.png)

``` {.r}
plot(predict(ppm6), main = "")
```

![](/home/rubak/spatstat/testWorkshop/docs/solutions/solution04_files/figure-markdown_github/unnamed-chunk-23-6.png)
